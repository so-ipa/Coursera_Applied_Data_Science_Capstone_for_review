...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(
                                    id='payload-slider', min=0, max=10000, step=1000, value=[min_payload, max_payload]),
...
def get_pie_chart(site):
    ...
    if site == 'ALL':
        ...
        fig = px.pie(df1, values='class count', names='class',
...
def scatter(site, payload):
    ...
    if site == 'ALL':
        ...
        fig = px.scatter(mask_filtered, x='Payload Mass (kg)', y='class',
                         color='Booster Version Category', title='Success count on Payload Mass for' + site)
        return fig
